...
<script lang="ts">
	...
	const TABS: { key: ImportTab; label: string; action: string; columns: string[] }[] = [
		...
		{ key: 'classFeatures',   label: 'Class Features',   action: '?/importClassFeatures',   columns: ['className','name','requiredLevel','description','url','grantsSkills','grantsExpertise','grantsHalfSkills','grantsSavingThrows','skillChoiceCount','skillChoicePool','savingThrowChoiceCount','savingThrowChoicePool','grantsTools','toolChoiceCount','toolChoicePool','grantsLanguages','languageChoiceCount','languageChoicePool','grantsResistances','grantsImmunities','grantsVulnerabilities','grantsInnateSpells'] },
		...
		{ key: 'backgrounds',     label: 'Backgrounds',      action: '?/importBackgrounds',     columns: ['name','shortDescription','featureName','grantsFeatCategory','grantsFeatId','grantsSkills','skillChoiceCount','skillChoicePool','savingThrowChoiceCount','savingThrowChoicePool','grantsTools','toolChoiceCount','toolChoicePool','grantsLanguages','languageChoiceCount','languageChoicePool','grantsResistances','grantsImmunities','grantsVulnerabilities','grantsInnateSpells','url','sortOrder'] },
		{ key: 'feats',           label: 'Feats',            action: '?/importFeats',           columns: ['name','description','snippet','repeatable','categories','prerequisites','detailsUrl','isEpicBoon','asiAmount','asiStatFixed','asiStatChoices','grantsSkills','grantsExpertise','grantsHalfSkills','grantsSavingThrows','skillChoiceCount','skillChoicePool','savingThrowChoiceCount','savingThrowChoicePool','grantsTools','toolChoiceCount','toolChoicePool','grantsLanguages','languageChoiceCount','languageChoicePool','grantsResistances','grantsImmunities','grantsVulnerabilities','grantsInnateSpells','sortOrder'] },
