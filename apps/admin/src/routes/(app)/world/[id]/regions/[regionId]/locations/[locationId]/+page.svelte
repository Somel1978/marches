<!-- apps/admin/src/routes/(app)/world/[id]/regions/[regionId]/locations/[locationId]/+page.svelte -->
<script lang="ts">
...
<div class="page">
	<div class="page__header">
		<div>
			<a href="/world/{(data.location.region as any)?.worldId}/regions/{data.location.regionId}" class="back-link">← {(data.location.region as any)?.name ?? 'Region'}</a>
