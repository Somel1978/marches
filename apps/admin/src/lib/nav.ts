...
//
// NavItemDef is a discriminated union:
//   { type: 'section', label } — renders as a section label in the sidebar
//   { type?: 'item', ... }    — renders as a nav link (default when type is omitted)
//
...
//
// Child hrefs and activeMatch also support functions — resolved with the same
// NavContext as the parent.
//
...
export type NavItemDef = NavItem | NavSection;

// Resolved nav items — what the layout svelte receives (no functions)
...
export type ResolvedNavItem =
    ...
    | { type: 'item'; label: string; icon: string; href: string; active: boolean; children?: ResolvedChild[] };
...
export const NAV_ITEMS: NavItemDef[] = [
    ...
    },
    {
        ...
        label:       'Token Store',
        href:        '/token-store',
        activeMatch: (pathname) => pathname.startsWith('/token-store'),
    ...
    },
    {
        ...
        label:       'News',
        href:        '/news',
        activeMatch: (pathname) => pathname.startsWith('/news'),
    ...
    },
    {
        ...
        label:       'Wiki',
        href:        '/wiki',
        activeMatch: (pathname) => pathname.startsWith('/wiki'),
    ...
    },
    {
        ...
        label:       'Discord',
        href:        '/discord',
        activeMatch: (pathname) => pathname.startsWith('/discord'),
